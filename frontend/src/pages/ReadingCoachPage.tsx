        ...
        {currentPassage && (
          <div className="mt-8 bg-blue-50 rounded-lg p-6">
            ...
            <ol className="list-decimal list-inside space-y-1 text-gray-700">
              <HoverTTS><li>Read the passage above aloud clearly</li></HoverTTS>
              <HoverTTS><li>Press "Start Reading" to begin</li></HoverTTS>
              <HoverTTS><li>Speak at a normal pace</li></HoverTTS>
              <HoverTTS><li>Press "Stop" when finished</li></HoverTTS>
              <HoverTTS><li>Review your feedback and practice tricky words</li></HoverTTS>
            </ol>
          </div>
        )}
      </div>
